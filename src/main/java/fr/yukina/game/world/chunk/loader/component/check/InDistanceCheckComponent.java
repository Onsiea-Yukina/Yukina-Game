...
public class InDistanceCheckComponent implements CheckComponent
{
	@Override
	public boolean check(ChunkLoaderContext context, ChunkManager.ChunkLoading chunkLoading)
	{
		...
		return !chunkManager.renderDistance().isOut(chunkLoading.x() * Terrain.WIDTH,
		                                            chunkLoading.z() * Terrain.DEPTH);
	}
}